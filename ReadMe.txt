...
Some important things to keep in mind are:
    ...
    sensitive, if this is deployed. Be sure you understand who might be able
    to gain access to these, and what that means for you. 
...
the currrent deployment process is as follows:
    ...
    1. Setup s3 bucket
     ...
     by using the s3 console directly.
